              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                  <img
                    ...
                    className="w-full h-full object-cover transition-transform duration-500 hover:scale-110"
                  />
                  <div className="absolute top-3 right-3 bg-purple-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg">
                    แนะนำ
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                  <img
                    ...
                    className="w-full h-full object-cover transition-transform duration-500 hover:scale-110"
                  />
                  <div className="absolute top-3 right-3 bg-orange-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg">
                    ใหม่
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
                  <img
                    ...
                    className="w-full h-full object-cover transition-transform duration-500 hover:scale-110"
                  />
                  <div className="absolute top-3 right-3 bg-teal-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg">
                    ราคาดี
                  </div>
                </div>
