...
import TourCard from '@/components/tour-search-3/TourCard'
import FilterSidebar from '@/components/tour-search-3/FilterSidebar'
import SortDropdown from '@/components/tour-search-3/SortDropdown'
import TourCardSkeleton from '@/components/tour-search-3/TourCardSkeleton'
import EmptyState from '@/components/tour-search-3/EmptyState'
import PopularDestinations from '@/components/tour-search-3/PopularDestinations'
import Breadcrumb from '@/components/tour-search-3/Breadcrumb'
import SEOContent from '@/components/tour-search-3/SEOContent'
import FAQ from '@/components/tour-search-3/FAQ'
import SearchBar from '@/components/tour-search-3/SearchBar'
import AdvancedFilterModal from '@/components/tour-search-3/AdvancedFilterModal'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative bg-gray-900 text-white py-12 sm:py-16 md:py-20 lg:py-24 px-4 overflow-hidden">
        ...
        <div className="mx-auto relative z-10" style={{ maxWidth: '1800px' }}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6" style={{ maxWidth: '1800px' }}>
        <PopularDestinations />
      </div>
        ...
        <main className="w-full">
          ...
          {isLoading ? (
            <div 
              ...
              style={{ 
                gridTemplateColumns: 'repeat(auto-fit, minmax(412px, 1fr))'
              }}
            >
              {[...Array(8)].map((_, i) => (
