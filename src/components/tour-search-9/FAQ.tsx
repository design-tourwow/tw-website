        ...
        <div className="space-y-2 sm:space-y-3">
          {faqData.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="text-sm sm:text-base font-semibold text-gray-900 pr-3 sm:pr-4 group-hover:text-[#0187e6] transition-colors">
                  {faq.question}
                </span>
                <svg
                  className={`w-4 h-4 sm:w-5 sm:h-5 text-[#019dff] flex-shrink-0 transition-transform duration-200 ${
              ...
              {openIndex === index && (
                <div className="mt-2 px-4 py-3 sm:px-5 sm:py-4 bg-[#e6f7ff]/40 rounded-lg sm:rounded-xl border border-[#e6f7ff]">
