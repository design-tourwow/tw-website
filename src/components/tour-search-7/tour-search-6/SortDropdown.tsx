  ...
  return (
    <div className="relative w-full lg:w-auto" ref={dropdownRef}>
      <button
        ...
        className="w-full lg:w-auto lg:min-w-[180px] h-[44px] flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 bg-white border border-gray-300 rounded-lg hover:border-gray-400 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm font-medium text-gray-700"
      >
