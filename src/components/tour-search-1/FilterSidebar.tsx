...
export default function FilterSidebar({ filters, onFilterChange, onReset, activeCount }: FilterSidebarProps) {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      <div className="space-y-7">
        ...
        <div className="pb-6 border-b border-gray-100">
          ...
          <div className="space-y-2 pl-1">
            {displayedHolidays.map((holiday) => (
              <label key={holiday.value} className="flex items-center cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-blue-50 transition-all duration-200">
        ...
        <div className="pb-6 border-b border-gray-100">
          ...
          <div className="space-y-2 pl-1">
            {priceRanges.map((range) => (
              <label key={range.value} className="flex items-center cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-blue-50 transition-all duration-200">
                <div className="relative">
                  <input
                    type="checkbox"
        ...
        <div className="pb-6 border-b border-gray-100">
          ...
          <div className="space-y-2 pl-1">
            {durations.map((duration) => (
              <label key={duration.value} className="flex items-center cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-blue-50 transition-all duration-200">
                <div className="relative">
                  <input
                    type="checkbox"
        ...
        <div className="pb-6 border-b border-gray-100">
          ...
          {/* Airlines List */}
          <div className="space-y-2 max-h-48 overflow-y-auto pl-1 hide-scrollbar">
            {displayedAirlines.map((airline) => (
              <label key={airline.value} className="flex items-center justify-between cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-blue-50 transition-all duration-200">
                ...
                <span className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors ml-2 flex-shrink-0">({airline.count})</span>
              </label>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="space-y-2 pl-1">
            {[3, 4, 5].map((stars) => (
              <label key={stars} className="flex items-center cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-blue-50 transition-all duration-200">
                <div className="relative">
                  <input
                    type="checkbox"
