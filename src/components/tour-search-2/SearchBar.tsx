  ...
  return (
    <>
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        {/* Advanced Filter Button - Below Search Bar */}
        <button
          onClick={() => setShowAdvancedModal(true)}
          className="mt-3 ml-auto flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl text-gray-700 hover:border-blue-500 hover:text-blue-700 hover:bg-blue-50 font-medium transition-all text-sm sm:text-base shadow-sm hover:shadow-md"
        >
