...
export default function FAQ() {
  ...
  return (
    <section className="mt-6 sm:mt-8">
      <div className="py-6 px-4 sm:py-8 sm:px-6 bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm">
          ...
          {faqData.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between py-3 px-4 sm:py-4 sm:px-5 text-left bg-gray-50 rounded-lg sm:rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-white hover:shadow-md transition-all"
              >
                <span className="text-sm sm:text-base font-semibold text-gray-900 pr-3 sm:pr-4 group-hover:text-blue-700 transition-colors">
                  {faq.question}
                </span>
                <svg
                  className={`w-4 h-4 sm:w-5 sm:h-5 text-blue-600 flex-shrink-0 transition-transform duration-200 ${
              ...
              {openIndex === index && (
                <div className="mt-2 px-4 py-3 sm:px-5 sm:py-4 bg-blue-50/40 rounded-lg sm:rounded-xl border border-blue-100">
