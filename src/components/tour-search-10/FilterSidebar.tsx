        ...
        <div className="pb-5 border-b border-gray-100">
          ...
          <div className={`space-y-2 pl-1 ${!showAllHolidays ? 'max-h-48 overflow-y-auto hide-scrollbar' : ''}`}>
            {(showAllHolidays ? holidays : holidays.slice(0, 5))
              ...
              const count = filterCounts.holidays[holiday.value] || 0
              return (
                <label key={holiday.value} className="flex items-center justify-between cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-[#e6f7ff] transition-all duration-200">
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="relative flex-shrink-0">
                      ...
                      />
                      <div className="w-5 h-5 border-2 border-gray-300 rounded-md peer-checked:border-[#019dff] peer-checked:bg-[#019dff] transition-all duration-200 flex items-center justify-center group-hover:border-[#019dff] group-hover:shadow-sm">
        ...
        <div className="pb-5 border-b border-gray-100">
          ...
          <div className="space-y-2 pl-1">
            {priceRanges
              ...
              const count = filterCounts.priceRanges[range.value] || 0
              return (
                <label key={range.value} className="flex items-center justify-between cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-[#e6f7ff] transition-all duration-200">
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="relative flex-shrink-0">
                      <input
                        type="checkbox"
        ...
        <div className="pb-5 border-b border-gray-100">
          ...
          <div className="space-y-2 pl-1">
            {durations
              ...
              const count = filterCounts.durations[duration.value] || 0
              return (
                <label key={duration.value} className="flex items-center justify-between cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-[#e6f7ff] transition-all duration-200">
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="relative flex-shrink-0">
                      <input
                        type="checkbox"
        ...
        <div className="pb-5 border-b border-gray-100">
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full pl-3 pr-10 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#e6f7ff]0 focus:border-transparent transition-all"
            />
          ...
          <div className={`space-y-2 pl-1 ${!showAllAirlines ? 'max-h-48 overflow-y-auto hide-scrollbar' : ''}`}>
            {(showAllAirlines ? filteredAirlines : filteredAirlines.slice(0, 5))
              ...
              const count = filterCounts.airlines[airline.value] || 0
              return (
                <label key={airline.value} className="flex items-center justify-between cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-[#e6f7ff] transition-all duration-200">
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="relative flex-shrink-0">
                      <input
                        type="checkbox"
        ...
        <div>
          ...
          <div className="space-y-2 pl-1">
            {[3, 4, 5]
              ...
              const count = filterCounts.ratings[stars] || 0
              return (
                <label key={stars} className="flex items-center justify-between cursor-pointer group px-2 py-2 -mx-2 rounded-lg hover:bg-[#e6f7ff] transition-all duration-200">
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="relative flex-shrink-0">
                      <input
                        type="checkbox"
